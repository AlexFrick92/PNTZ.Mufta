...
PMR_MR_TOTAL_RESULT     DWORD           (2=NIO, 1=IO)	Оценка АРМ
...
Чтобы в OPC UA можно было считать время, в программе ПЛК1517 метки времени нужно создавать с типом LDT и выполнить конвертацию DATE_AND_TIME в LDT.
